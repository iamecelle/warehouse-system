    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 col-md-offset-1">
                <div class="box">
                    <div class="box-header">Product <b>{{ $product->name }}</b></div> <div class="box-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Name</th><td> {{ $product->name }} </td></tr><tr><th> Description </th><td> {{ $product->description }} </td></tr><tr><th>Section ID </th><td> {{ $product->section_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
